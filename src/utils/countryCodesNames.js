const countryCodesNames = [
  ...
  { code: "bj", names: "Benin" },
  { code: "bl", names: "Saint Barthelemy" },
  ...
  { code: "bzh", names: "Brittany, Bretagne" },
  { code: "ca", names: "Canada" },
  { code: "caqc", names: "Quebec" },
  { code: "cc", names: "Cocos (Keeling) Islands" },
  { code: "cg", names: "Congo" },
  { code: "cd", names: "Democratic Republic of the Congo" },
  { code: "cf", names: "Central African Republic" },
  { code: "ch", names: "Switzerland" },
  { code: "ci", names: "Cote d'Ivoire, Ivory Coast" },
  ...
  { code: "it", names: "Italy" },
  { code: "itsrd", names: "Sardinia, Sardegna" },
  ...
  { code: "md", names: "Moldova, Moldavia" },
  { code: "me", names: "Montenegro" },
  { code: "mf", names: "Saint Martin, St Martin" },
  ...
  { code: "mypg", names: "Penang" },
  { code: "mysb", names: "Sabah" },
  ...
  { code: "pm", names: "Saint Pierre and Miquelon, St Pierre and Miquelon" },
  ...
  { code: "sx", names: "Sint Maarten" },
  { code: "sy", names: "Syria" },
  { code: "sz", names: "Swaziland, eSwatini" },
  { code: "tb", names: "Tibet" },
  ...
  { code: "us", names: "US, USA, United States" },
  { code: "usak", names: "Alaska" },
  { code: "usal", names: "Alabama" },
  { code: "usar", names: "Arkansas" },
  { code: "usaz", names: "Arizona" },
  { code: "usca", names: "California" },
  { code: "usco", names: "Colorado" },
  { code: "usct", names: "Connecticut" },
  { code: "usde", names: "Delaware" },
  { code: "usfl", names: "Florida" },
  { code: "ushi", names: "Hawaii" },
  { code: "usia", names: "Iowa" },
  { code: "usid", names: "Idaho" },
  { code: "usil", names: "Illinois" },
  { code: "usin", names: "Indiana" },
  { code: "usks", names: "Kansas" },
  { code: "usky", names: "Kentucky" },
  { code: "usla", names: "Louisiana" },
  { code: "usma", names: "Massachusetts" },
  { code: "usmd", names: "Maryland" },
  { code: "usme", names: "Maine" },
  { code: "usmi", names: "Michigan" },
  { code: "usmn", names: "Minnesota" },
  { code: "usmo", names: "Missouri" },
  { code: "usms", names: "Mississippi" },
  { code: "usmt", names: "Montana" },
  { code: "usnc", names: "North Carolina" },
  { code: "usnd", names: "North Dakota" },
  { code: "usne", names: "Nebraska" },
  { code: "usnh", names: "New Hampshire" },
  { code: "usnj", names: "New Jersey" },
  { code: "usnm", names: "New Mexico" },
  { code: "usnv", names: "Nevada" },
  { code: "usny", names: "New York" },
  { code: "usoh", names: "Ohio" },
  { code: "usok", names: "Oklahoma" },
  { code: "usor", names: "Oregon" },
  { code: "uspa", names: "Pennsylvania" },
  { code: "usri", names: "Rhode Island" },
  { code: "ussc", names: "South Carolina" },
  { code: "ussd", names: "South Dakota" },
  { code: "ustn", names: "Tennessee" },
  { code: "ustx", names: "Texas" },
  { code: "usut", names: "Utah" },
  { code: "usva", names: "Virginia" },
  { code: "usvt", names: "Vermont" },
  { code: "uswa", names: "Washington" },
  { code: "uswi", names: "Wisconsin" },
  { code: "uswv", names: "West Virginia" },
  { code: "uswy", names: "Wyoming" },
  { code: "uy", names: "Uruguay" },
  { code: "uz", names: "Uzbekistan" },
  { code: "va", names: "Vatican, Vatican City, Holy See" },
  { code: "vc", names: "Saint Vincent and the Grenadines" },
  { code: "ve", names: "Venezuela" },
  { code: "vg", names: "British Virgin Islands" },
  { code: "vi", names: "US Virgin Islands" },
...
module.exports = countryCodesNames;